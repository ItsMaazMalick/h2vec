        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted-fg leading-relaxed max-w-65">
              Building Pakistan&apos;s open ML data infrastructure — one dataset at a time.
            </p>
            <div className="flex items-center gap-3 mt-5">
              {socials.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  className="w-8 h-8 rounded-md flex items-center justify-center text-muted hover:text-foreground hover:bg-surface-raised transition-colors"
                >
